                                ...
                                <div class="col">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" class="tbl_quantity form-control" id="cantidadProducto<?php echo $values['idProducto']; ?>" name="cantidadProducto<?php echo $values['idProducto']; ?>" value="<?php echo  $_SESSION["cantidadProducto" . $values["idProducto"]]; ?>" onblur=calcularPrecio(<?php echo $values["idProducto"]; ?>);>
                                                </td>
                                                <td>
                                                    <div class="tbl_total_action">
                                                        <h4 class="tbl_total total_precio" id="totalProducto<?php echo $values["idProducto"]; ?>">¢<?php echo $_SESSION["totalProducto" . $values['idProducto']]; ?></h4>
