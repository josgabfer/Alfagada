<?php
    ...
    $consultarProducto = "call ConsultarProducto('Limpieza')";
...
<body>
    ...
    <div class="min-banner img-fluid">
      <img src="Resources/imgs/limpieza.jpeg"  alt="...">
    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="text-center">
                        <h2 class="checkout_title">Limpieza</h2>
    ...
    <div class="row">
      ...
      ?>
           <div class="col-lg-3 col-md-4 col-sm-6">
                  <form method="post" action="limpieza.php?action=add&id=<?php echo $row["id"]; ?>">
