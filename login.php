...
//Inicio de sesion
    ...
    //opcion de registrar, para obtener valores y ser asignadas a las variables que seran utilizadas en la consulta a la base de datos
    ...
    //opcion de ingreso/inicio de sesion, al iniciar sesion, eso guarda la informacion del usaurio en las varialbes de sesion corespondientes para el usuario
...
<form action="" method="post" onsubmit="return validarForm(this);">
    ...
    <script>
        ...
        {  //Validacion de registro toma la informacion ingresada por el usuario.
            if($("#regNombre").val() == "")
            {
